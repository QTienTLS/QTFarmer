...
!(function (e) {
    ...
    try {
        R.apply((q = $.call(N.childNodes)), N.childNodes),
            q[N.childNodes.length].nodeType;
    } catch (e) {
        R = {
            apply: q.length
                ? function (e, t) {
    ...
    function le(e, t, r, i) {
        ...
        if (
            ((r = r || []),
            'string' != typeof e || !e || (1 !== N && 9 !== N && 11 !== N))
        )
            return r;
        if (!i && (f(t), (t = t || p), g)) {
            if (11 !== N && (d = _.exec(e)))
            ...
            if (
                ...
                !D[e + ' '] &&
                (!m || !m.test(e)) &&
                (1 !== N || 'object' !== t.nodeName.toLowerCase())
            ) {
                      ...
                      ? function (e, t) {
                            ...
                            return (
                                ...
                                (!n.sortDetached &&
                                    ...
                                    ? e == p ||
                                      (e.ownerDocument == N && w(N, e))
                                        ? -1
                                        : t == p ||
                                          (t.ownerDocument == N && w(N, t))
                                        ? 1
                                        : s
                                        ? k(s, e) - k(s, t)
                                        : 0
                      ...
                      while ((t = t[r]))
                          if (1 === t.nodeType || u)
                              if (
                                  ...
                                  if ((c = s[o]) && c[0] === C && c[1] === l)
                                      return (f[2] = c[2]);
                                  if (((s[o] = f), (f[2] = e(t, n, a))))
                                      return !0;
                              }
                  return !1;
              };
